...
class AllFieldsTable extends StatelessWidget {
  final List<AssignField> fields;

  const AllFieldsTable({super.key, required this.fields});
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: const [
          ...
          DataColumn(label: Text('Assigned Agent')),
        ...
        rows: fields.map((field) {
          return DataRow(cells: [
            ...
            DataCell(Text(field.agent ?? "Unassigned")),
